...
export type AiConfig = {
    ...
    galleryImageProfileId?: string;
    galleryImageParams?: TaskParams;
    galleryTextProfileId?: string;
};
...
function isAiConfigReady(config: AiConfig, model: string) {
    if (config.galleryImageProfileId || config.galleryTextProfileId) return Boolean(config.baseUrl.trim() && config.apiKey.trim() && model.trim());
