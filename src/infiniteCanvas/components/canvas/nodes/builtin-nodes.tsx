...
const BUILTIN_DEFINITIONS: CanvasNodeDefinition[] = [
    ...
    { type: CanvasNodeType.Image, title: "图片", icon: <ImageIcon className={iconClass} />, minimapColor: "#2563eb", keepAspectRatio: (node: CanvasNodeData) => !node.metadata?.freeResize, resource: builtinResource },
    { type: CanvasNodeType.Video, title: "视频", icon: <Video className={iconClass} />, minimapColor: "#2563eb", keepAspectRatio: () => true, resource: builtinResource },
    { type: CanvasNodeType.Audio, title: "音频", icon: <Music2 className={iconClass} />, minimapColor: "#2563eb", resource: builtinResource },
    { type: CanvasNodeType.Config, title: "生成配置", icon: <Settings2 className={iconClass} />, minimapColor: "#2563eb", hasSourceHandle: false },
    { type: CanvasNodeType.Group, title: "组", icon: <Group className={iconClass} />, minimapColor: "#a1a1aa" },
].map((def) => {
