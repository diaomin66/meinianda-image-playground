...
export function CanvasProjectCard({ project }: { project: CanvasProject }) {
    ...
    return (
        <article className="group flex min-h-44 cursor-pointer flex-col justify-between rounded-2xl bg-zinc-100 p-5 transition hover:bg-zinc-200 dark:bg-white/5 dark:hover:bg-white/10" onClick={() => !editing && open()}>
