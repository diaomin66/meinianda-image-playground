...
export default function Toast() {
  const currentToast = useStore((s) => s.toast)
  const { value: toast, closing } = useExitPresence(currentToast)
  ...
  return (
    <div data-closing={closing} role="status" className="fixed bottom-24 left-1/2 z-[120] pointer-events-none toast-enter">
